...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">blo-camisadez documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link" >AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-73700d1b0aef40778c00afd2c162d190"' : 'data-target="#xs-components-links-module-AppModule-73700d1b0aef40778c00afd2c162d190"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-73700d1b0aef40778c00afd2c162d190"' :
                                            'id="xs-components-links-module-AppModule-73700d1b0aef40778c00afd2c162d190"' }>
                                            <li class="link">
